...
const details = [
  ...
  },
  {
    ...
    subtitle: "Event path",
    purpose: "Audit emission is S11 on the API request spine; it is async and MUST NOT block response completion in S12.",
    defines: [
      "Correlation id is propagated from edge when present; cross-layer correlation is a separate integration contract.",
  ...
  },
  {
    ...
    subtitle: "Spine id S11",
    purpose: "Ordering relative to handler completion is fixed: S11 after successful gate passage and handler outcome known; still non-blocking.",
    defines: [
      "S11: build redacted event, enqueue/buffer, flush async; request thread continues per S12.",
    ],
    doesNotDefine: "Sink vendor APIs.",
