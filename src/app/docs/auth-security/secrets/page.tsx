...
const details = [
  ...
  },
  {
    ...
    subtitle: "Usage path",
    purpose: "Signing material for S04 is platform lifecycle concern; hot-path usage is implied by S04 but key load/rotate is not part of S01–S12 ordering.",
    defines: [
      "JWT verify at S04 MUST use server-held public or symmetric verify keys matching session-spec iss/kid policy.",
      "Secrets never appear in error-contracts payloads or client-visible JSON.",
    ],
  ...
  },
  {
    ...
    subtitle: "Out-of-band from request spine",
    purpose: "Key load, rotation, dual-verify windows are operational state machines; they do not insert rows into S01–S12. Document rotation windows alongside session-spec kid handling.",
    defines: [
      "Process start hydration, rotation, dual-verify, retire: sequence is deployment runbook, not reordered into API spine.",
      "S04 consumer MUST honor active key set published for verification.",
    ],
